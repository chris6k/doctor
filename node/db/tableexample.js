[{
   "title":"创伤RAPT量表",
   "summary":"<div class='tips'>* 胸部 AIS>2分<br/>**腹部 AIS>2分<br/>***头部 AIS>2分<br/>****GCS<8分<br/>RAPT评分<br/> 免责声明 <br/> 本量表参考《创伤骨科患者深静脉血栓形成筛查与治疗的专家共识 中华创伤骨科杂志 2013,15(12)》<br/> 请患者在医务工作者指导下进行填写，本量表最终结果仅供专业医务工作者参考</div>",
   "items":
   [
   {
       "title":"病史",
