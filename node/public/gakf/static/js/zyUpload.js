		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
		           ...
		           // html += '					<div class="webuploader_pick">选择文件</div>';
				    ...
				    html += '					<a style="height:'+imgWidth+'px;width:'+imgWidth+'px;" title="点击添加文件" id="rapidAddImg" class="add_imgBox" href="javascript:void(0)">';
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				if (file.type.indexOf("image") == 0) {
					...
					html += '		</div>';
					html += '	</div>';
					html += '	<a style="height:'+imgWidth+'px;width:'+imgWidth+'px;" href="#" class="imgBox">';
					html += '		<div class="uploadImg" style="width:'+imgWidth+'px;height:'+imgWidth+'px">';				
					html += '			<img id="uploadImage_'+file.index+'" class="upload_image" src="' + e.target.result + '" style="width:'+imgWidth+'px;height:'+imgWidth+'px !important;" />';                                                                 
					html += '		</div>';
					html += '	</a>';
					...
					html += '		</div>';
					html += '	</div>';
					html += '	<a style="height:'+para.itemHeight+'px;width:'+para.itemWidth+'px;" href="#" class="imgBox">';
					html += '		<div class="uploadImg" style="width:'+imgWidth+'px">';				
					html += '			<img id="uploadImage_'+file.index+'" class="upload_image" src="' + fileImgSrc + '" style="width:'+imgWidth+'px;height:'+imgWidth+'px !important;" />';                                                                 
					html += '		</div>';
					html += '	</a>';
					html += '	<p id="uploadProgress_'+file.index+'" class="file_progress"></p>';
					html += '	<p id="uploadFailure_'+file.index+'" class="file_failure">上传失败，请重试</p>';
